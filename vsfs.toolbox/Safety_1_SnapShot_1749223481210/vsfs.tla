...
\* BEGIN TRANSLATION (chksum(pcal) = "afedfdc7" /\ chksum(tla) \in STRING)
VARIABLES freeBlocks, inodes, dir, curFileName, delete_stage

(* define statement *)
MaxBlocksPerFile == 2


vars == << freeBlocks, inodes, dir, curFileName, delete_stage >>
...
\* Last modified Fri Jun 06 18:24:34 IDT 2025 by eitam
